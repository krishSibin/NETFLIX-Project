...
mixin _$DownloadsState {
  ...
  List<Downloads> get downloadList => throw _privateConstructorUsedError;
  Option<Either<MainFailure, List<Downloads>>>
      get downloadsSucessOrFailureOption => throw _privateConstructorUsedError;
...
class _$DownloadsStateCopyWithImpl<$Res, $Val extends DownloadsState>
  ...
  $Res call({
    ...
    Object? downloadsSucessOrFailureOption = null,
  }) {
    return _then(_value.copyWith(
      ...
      downloadList: null == downloadList
          ...
          : downloadList // ignore: cast_nullable_to_non_nullable
              as List<Downloads>,
      downloadsSucessOrFailureOption: null == downloadsSucessOrFailureOption
          ? _value.downloadsSucessOrFailureOption
          : downloadsSucessOrFailureOption // ignore: cast_nullable_to_non_nullable
...
class _$_DownloadsState implements _DownloadsState {
  const _$_DownloadsState(
      ...
      required final List<Downloads> downloadList,
      required this.downloadsSucessOrFailureOption})
      : _downloadList = downloadList;

  @override
  final bool isLoading;
  final List<Downloads> _downloadList;
  @override
  List<Downloads> get downloadList {
  ...
  @override
  String toString() {
    return 'DownloadsState(isLoading: $isLoading, downloadList: $downloadList, downloadsSucessOrFailureOption: $downloadsSucessOrFailureOption)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.downloadsSucessOrFailureOption,
                    downloadsSucessOrFailureOption) ||
                other.downloadsSucessOrFailureOption ==
                    downloadsSucessOrFailureOption));
  }
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      required final Option<Either<MainFailure, List<Downloads>>>
          downloadsSucessOrFailureOption}) = _$_DownloadsState;
  ...
  @override
  Option<Either<MainFailure, List<Downloads>>>
      get downloadsSucessOrFailureOption;
  @override
  @JsonKey(ignore: true)
  _$$_DownloadsStateCopyWith<_$_DownloadsState> get copyWith =>
      throw _privateConstructorUsedError;
