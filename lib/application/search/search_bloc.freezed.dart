...
/// @nodoc
mixin _$SearchState {
  List<ResultData> get searchResultList => throw _privateConstructorUsedError;
...
abstract class $SearchStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<ResultData> searchResultList,
...
class _$_SearchState implements _SearchState {
  const _$_SearchState(
      {required final List<ResultData> searchResultList,
  ...
  final List<ResultData> _searchResultList;
  @override
  List<ResultData> get searchResultList {
